...
const Home = () => {
    return (
        <div className='text-[#202030]'>
            <div className='mt-[16px] md:mt-[36px] lg:mt-[56px] h-[520px] md:h-[650px] lg:h-[750px] shadow-lg bg-gradient-to-tr from-[#E8F1F2] to-[#642CA9] max-w-[1600px]  w-full mx-auto rounded-lg flex-col justify-center ' >
                <div class="flex mb-4">
                    <div class="w-2/3">
                        <h2 className='mt-5 text[40px] md:text-[40px] xl:text-[60px] text-[#202030] font-barlow  text-opacity-60 mx-5 ' >hi there, I'm </h2>
                        ...
                        <div class="flex mb-4">
                            <div class="h-8 md:h-10 xl:h-12 w-1/6 bg-gray-500 font-game-over">
                                <h1 className='text-[100px] md:text-[150px] xl:text-[200px] mt-20 lg:mt-5 text-end'>&#123;</h1>
                            </div>
                            ...
                            <div class="h-8 md:h-10 xl:h-12 w-1/6 bg-gray-500 font-game-over">
                                <h1 className='text-[100px] md:text-[150px] xl:text-[200px] mt-20 lg:mt-5 text-start'>&#125;</h1>
                            </div>
                        </div>
                    </div>
                    <div class="h-35 w-46 md:h-45 md:w-66 xl:h-50 xl:w-96 mx-10 my-20 shadow-2xl ">
