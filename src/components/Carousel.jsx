...
const Carousel = () => {
    ...
    return (
        ...
        <div className='h-[520px] md:h-[650px] lg:h-[750px] shadow-lg bg-slate-500 max-w-[1600px]  w-full  mx-auto rounded-2xl flex-col justify-center'>
            {project.map((elems, idx) => (
                <div className={`${idx === activeImage
                    ...
                    <div className='flex'>
                        <div className=' w-1/3 '><img src={elems.src} className='h-[520px] md:h-[650px] lg:h-[750px] object-cover rounded-tl-2xl rounded-bl-2xl '></img></div>

                        <div className='w-2/3 ' >

                            <div className='font-fatface-reg font-bold text-[40px] md:text-[60px] lg:text-[100px] text-center'>{elems.title}</div>
                            {/* <div className='text-[8px] md:text-[15px] xl:text-[18px] font-anaheim text-center mt-28'>{elems.tags}</div> */}
                            <div className='text-[8px] md:text-[15px] xl:text-[18px] font-anaheim text-center mt-28 mx-28'>{elems.desc}</div>
                            ...
                            <div class="flex mb-4 items-end justify-end  ">
                                ...
                                <div class="w-3/5  flex justify-center  h-[30px]  hover:scale-125 hover:cursor-pointer transition duration-500"><a href={elems.srcCode} className='bg-indigo-500  w-[120px] rounded-xl text-white flex items-center justify-center'>Source Code</a></div>
